...
Turkish language pack for Hytale. The goal is to offer a more natural experience in everyday gameplay, translating interface texts and common messages to make playing and configuring everything more comfortable in Turkish.

## ⚙️ Installation

1. **Locate Game Directory**: Go to the game's root folder. If you don't know where it is, open the launcher → Settings → "Open Directory"

2. **Extract Files**: Open the downloaded `.zip` file and drag the `install` folder into Hytale's root directory

3. **Replace Files**: Select "Replace all" when prompted

4. **In-Game Setup**: Launch Hytale, go to Settings, and select **Turkish (Türkiye)** as the language

## ⚠️ Important Notice

**CurseForge App Users**: If you download using the CurseForge application, **delete the .zip file** from the mods folder after installation, as it may prevent your world from loading.

## 📊 Current Status

This translation is **stable** but continuously improving. You may encounter some untranslated lines or expressions that could be enhanced. Future updates will refine and expand the translation coverage.
